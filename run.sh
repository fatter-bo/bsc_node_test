...
nohup ./geth_linux  --verbosity=3 --syncmode fast --diffsync --config ./config.toml --datadir ${PWD}/node  --cache 6144 --rpc.allow-unprotected-txs --txlookuplimit 0  --http --http.addr 0.0.0.0 --http.port 28545 --ws --ws.addr 0.0.0.0 --ws.port 28546 &
